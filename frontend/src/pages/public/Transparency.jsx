...
export default function Transparency() {
  ...
  const breakdown = data?.expenseBreakdown
    ? Object.entries(data.expenseBreakdown).map(([name, value]) => ({
        name: name.replace("_", " "),
        value,
      }))
    : [];
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div className="trans-body">
        <p className="trans-intro">
          Updated automatically from the society's cash ledger. Every flat owner
          can see exactly where the maintenance fund stands and how it is spent
          — including the actual bill, where one has been uploaded.
        </p>
        ...
        {data && (
          <>
            <div className="stat-grid cols-4">
              <div className="stat-card">
                ...
                <div className="stat-value">
                  ₹{Number(data.totalFund).toLocaleString("en-IN")}
                </div>
              </div>
              <div className="stat-card">
            ...
            <div className="card chart-box" style={{ marginTop: 16 }}>
              <div className="card-title">Recent Spending (last 20)</div>
