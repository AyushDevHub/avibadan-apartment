...
// area is in sq.ft — used to split Special Project costs proportionally,
// and as the basis for rate/sq.ft if maintenance is ever priced per sq.ft.
const FLATS = [
  {
    num: "Flat-1",
    owner: "Pradyut Kumar Ghosh",
    rate: 355,
    area: 710,
    username: "pradyut",
    password: "flat1pass",
  ...
  {
    num: "Flat-3",
    owner: "Pushparghya Ghosh",
    rate: 238,
    area: 476,
    username: "pushparghya",
    password: "flat3pass",
  },
  {
    num: "Flat-4",
    owner: "Aniruddha Mukherjee",
    rate: 813,
    area: 1626,
    username: "aniruddha",
    password: "flat4pass",
...
async function main() {
  ...
  for (const f of FLATS) {
    console.log(
      `  ${f.num.padEnd(8)} ${f.owner.padEnd(24)} username "${f.username.padEnd(
        12
      )}" / password "${f.password}"`
    );
  }
  ...
  console.log(
    "January 2026 opening balance. Then Maintenance Bills -> Generate,"
  );
